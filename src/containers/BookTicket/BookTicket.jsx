...
class BookTicket extends Component {
    ...
    setNumberSeatChose(array) {
        this.setState({ arrayPositionSeat: array });
    }
            ...
            case this.state.STEP_ONE:
                return (
                    <div className="option__detail -number-ticket">
                        ...
                        <input type="number" name="number" id="number-ticket" value={1} onChange={() => { this.onChangNumberTicket() }} /> <br />
                    </div>
            ...
            case this.state.STEP_TWO:
                ...
                return (
                    <div class="option__detail">
                        <SeatingPlant stateSeat={stateSeat} maxSeat={3} setNumberSeatChose={() => { this.state.setNumberSeatChose() }} />
                    </div>
                )
